...
import com.grinderwolf.swm.core.version.legacy.reader.impl.v1_9SlimeWorldFormat;
...
public class SlimeWorldReaderRegistry {
    ...
    public static LegacyCraftSlimeWorld readWorld(SlimeLoader loader, String worldName, byte[] serializedWorld, SlimePropertyMap propertyMap, boolean readOnly) throws IOException, CorruptedWorldException, NewerFormatException {
