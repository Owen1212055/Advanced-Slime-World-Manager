...
@Setter
@AllArgsConstructor
public class LegacyCraftSlimeWorld implements SlimeWorld {
    ...
    public SlimeWorld clone(String worldName, SlimeLoader loader, boolean lock) throws WorldAlreadyExistsException, IOException {if (name.equals(worldName)) {
        ...
        LegacyCraftSlimeWorld world;

        synchronized (chunks) {
            world = new LegacyCraftSlimeWorld(loader == null ? this.loader : loader, worldName, new HashMap<>(chunks), extraData.clone(),
